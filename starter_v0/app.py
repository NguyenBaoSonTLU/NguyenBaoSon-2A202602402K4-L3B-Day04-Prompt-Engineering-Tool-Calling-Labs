...
artifact_ver = build_artifact_version("v4", SYSTEM_PROMPT_PATH, TOOLS_PATH)

st.title("🛠️ IT Helpdesk Agent — Hong Nhung")
...
if prompt := st.chat_input("Nhập yêu cầu hỗ trợ IT..."):
    ...
    provider = make_provider("openai")  # Hoặc provider nhóm sử dụng
